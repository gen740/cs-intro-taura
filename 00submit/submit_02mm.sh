...
batch_main() {
    ...
    echo "################################################## Sequencial"
    ../02mm/exe/mm_seq.exe -K 1000 -M 1000 -N 1024 > mm_seq0.log

    echo "################################################## SIMD"
    ../02mm/exe/mm_simd.exe -K 1000 -M 1000 -N 1024 > mm_simd0.log

    echo "################################################## Omp"
    OMP_PROC_BIND=true OMP_NUM_THREAD=56 ../02mm/exe/mm_omp.exe -K 1000 -M 1000 -N 1024 > mm_omp0.log
}
